...
class Tyre:
    ...
    def __init__(self, initialGrip, initialDeg, switchPoint, switchDeg):
        ...
        # A small check to set tyreCompound, used mainly for checking current tyre abd changing tyre at pitstop
    ...
    def addLap(self, fuelEffect, gripLossFactor):  # Used to add laps, called from simulateRace in Car class
        # print("Start: ", self.currentGrip)  # Used for testing purpose
        # print("Fuel effect: ", fuelEffect)  # Used for testing purpose
        ...
        # print("End: ", self.currentGrip)  # Used for testing purpose
...
class Car:
    ...
    def simulateRace(self):
        if self.isValidStrategy():  # Checking if the tyre and pitstop configurations are valid
            self.resetTyres()
            ...
            while self.currentLap != self.maxLapsForRace:
                ...
                # print("Started lap with : ", self.currentFuel)  # Used for testing
                ...
                self.currentTyre.addLap(self.fuelEffect, self.gripLossFactor)  # Degrades tyre based on fuel on board and grip loss
                self.currentFuel -= 1.5  # Fuel depletion
                print("")
        else:
            print("Invalid!")
            return False

    # Sets tyres grips to initial values
    def resetTyres(self):
    ...
    #
    # FOR SIMULATED ANNEALING - Unable to implement
    #

    def changeCompound(self):
        # Tried to implement simulated annealing by having it randomly change compounds / pitstop after each run and first pit be 1-35 and second part be 36-70
...
tyre1 = Tyre(2.0, 0.03, 1.8, 1.2)  # soft
tyre2 = Tyre(1.6, 0.02, 1.3, 1.2)  # medium
tyre3 = Tyre(1.1, 0.01, 0.85, 1.2)  # hard

# Pitstops
pits1 = [40, 50]  # pitstop for 1st car
pits2 = [25, 55]  # pitstop for 2nd car
pits3 = [30, 60]  # pitstop for 3rd car

# Tyres for pitstops
tyres1 = [tyre2, tyre3]  # Pit tyres for 1st car
tyres2 = [tyre1, tyre3]  # Pit tyres for 2nd car
tyres3 = [tyre1, tyre2]  # Pit tyres for 3rd car
...
# Plots the lap times for all three cars
